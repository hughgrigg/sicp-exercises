...
; For applicative-order evaluation, there will be an infinite loop in trying to
; evaluate p, due to the circular reference to the expression in p.
;
; For normal-order evaluation, the following expansion will occur:
; (test 0 (p))
; (if (= 0 0)
;     0
;     (p)))
