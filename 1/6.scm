...
; This may run infinitely because of applicative order evaluation?
; The else-clause is still evaluated with each call of sqrt-iter, even if the 
; good-enough? cond is passed.